...
import ContactComments from './routes/contact-comments/Index.vue'
import ContactCommentTypes from './routes/contact-comment-types/Index.vue'
...
let crmRoutes = [
  ...
  {
    path: 'contact-comment-types',
    name: 'contactCommentTypes',
    component: ContactCommentTypes,
  },
  {
    path: 'companies',
    name: 'companies',
